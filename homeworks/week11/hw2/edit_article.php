<?php
  ...
  */
  ...
  $stmt = $conn->prepare('select * from YiHeng_blog_articles where article_id = ?
  ');
    ...
    <div class="article_body">
      <form method="POST" action="handle_update_article.php">
        <div class="add_article">
          <input type="title" name="article_title" value="<?php echo $row['article_title']; ?>" />
          ...
          <textarea class="textareaWithCKEditor" style="background-color: white;" name="article_content" rows="5"><?php echo $row['article_content']; ?></textarea>
          <script>
              ClassicEditor
